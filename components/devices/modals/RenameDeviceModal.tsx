    ...
    <div className="fixed inset-0 bg-black/30 dark:bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-xl w-full max-w-md p-6 border border-gray-200 dark:border-gray-700">
        ...
        <input
          ...
          className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-900 dark:text-white placeholder-gray-500 dark-placeholder dark:placeholder-gray-400"
        ...
        <div className="flex justify-end gap-3 mt-6">
          ...
          <button
            ...
            className="px-6 py-2.5 bg-bgBlue hover:bg-blue-600 shadow-customShadow text-white rounded-xl font-medium transition-colors"
          >
            Save
          </button>
        </div>
