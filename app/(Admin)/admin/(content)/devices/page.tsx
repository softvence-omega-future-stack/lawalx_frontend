...
const generateDevicesData = () => {
  const devices = [
    ...
    { device: 'Reception Display', model: 'TV-001-NYC', customer: 'TechCorp Inc.', location: 'New York, NY', type: 'Android TV', status: 'Online', storage: '8.5 GB / 16 GB', uptime: '99.8%', daysAgo: 0.5 },
    { device: 'Menu Board', model: 'TV-002-LA', customer: 'Restaurant Group', location: 'Los Angeles, CA', type: 'Fire TV', status: 'Online', storage: '3.2 GB / 8 GB', uptime: '98.5%', daysAgo: 0.8 },
    
    // Last 7 days devices (2-6 days ago)
    { device: 'Lobby Screen', model: 'TV-003-CHI', customer: 'Healthcare Network', location: 'Chicago, IL', type: 'Samsung Tizen', status: 'Offline', storage: '12.8 GB / 16 GB', uptime: '95.2%', daysAgo: 3 },
    { device: 'Store Display', model: 'TV-004-MIA', customer: 'RetailStore Chain', location: 'Miami, FL', type: 'LG webOS', status: 'Syncing', storage: '5.7 GB / 32 GB', uptime: '99.1%', daysAgo: 5 },
    { device: 'Conference Room', model: 'TV-005-BOS', customer: 'Tech Solutions', location: 'Boston, MA', type: 'Android TV', status: 'Online', storage: '4.2 GB / 16 GB', uptime: '97.8%', daysAgo: 6 },
    
    // Last 30 days devices (8-28 days ago)
    { device: 'Lobby Display', model: 'TV-006-SEA', customer: 'Coffee Chain', location: 'Seattle, WA', type: 'Fire TV', status: 'Online', storage: '6.1 GB / 16 GB', uptime: '99.3%', daysAgo: 15 },
    { device: 'Menu Board', model: 'TV-007-DEN', customer: 'FastFood Group', location: 'Denver, CO', type: 'Samsung Tizen', status: 'Online', storage: '7.8 GB / 16 GB', uptime: '98.9%', daysAgo: 20 },
    { device: 'Waiting Room', model: 'TV-008-PHX', customer: 'Medical Center', location: 'Phoenix, AZ', type: 'LG webOS', status: 'Syncing', storage: '5.3 GB / 32 GB', uptime: '99.5%', daysAgo: 28 },
    
    // Last 1 year devices (31-364 days ago)
    { device: 'Retail Display', model: 'TV-009-ATL', customer: 'Shopping Mall', location: 'Atlanta, GA', type: 'Android TV', status: 'Online', storage: '9.2 GB / 16 GB', uptime: '96.7%', daysAgo: 45 },
    { device: 'Office Screen', model: 'TV-010-DAL', customer: 'Corporate HQ', location: 'Dallas, TX', type: 'Fire TV', status: 'Online', storage: '5.8 GB / 16 GB', uptime: '98.2%', daysAgo: 90 },
    { device: 'Hotel Lobby', model: 'TV-011-LAS', customer: 'Hotel Chain', location: 'Las Vegas, NV', type: 'Samsung Tizen', status: 'Online', storage: '11.4 GB / 16 GB', uptime: '97.5%', daysAgo: 180 },
    { device: 'Store Front', model: 'TV-012-POR', customer: 'Electronics Store', location: 'Portland, OR', type: 'LG webOS', status: 'Offline', storage: '6.9 GB / 32 GB', uptime: '94.8%', daysAgo: 300 },
  ];
