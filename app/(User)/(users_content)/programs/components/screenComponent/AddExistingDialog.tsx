...
const AddExistingDialog = ({ open, setOpen }: AddContentDialogProps) => {
    ...
    return (
        ...
        >
          ...
          />
            ...
            {/* Buttons */}
            <div className="flex flex-col md:flex-row justify-end gap-3 pt-4 border-t mt-4">
                <Button
                    variant="outline"
                    onClick={handleClearSelection}
                    className="border-border shadow-customShadow font-semibold text-base hover:bg-bgBlue hover:text-white w-full md:w-1/4"
                >
                    Cancel
                </Button>
                ...
                <Button
                    ...
                    className="bg-bgBlue px-6 hover:bg-blue-500 font-semibold text-base text-white disabled:opacity-50 w-full md:w-1/4 shadow-customShadow"
                >
                    Add
                </Button>
            </div>
...
export default AddExistingDialog;
