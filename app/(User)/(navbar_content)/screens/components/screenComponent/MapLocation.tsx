...
// (Leaflet expects these URLs to be set when using bundlers)
...
// Custom marker icon with monitor (DivIcon)
...
// Zoom control component (must be a child of MapContainer so useMap() works)
...
const MapLocation: React.FC = () => {
    // Center coordinates for Idaho/Montana region
    ...
    return (
        <div className="">
            {/* Header */}
            <div className="mb-6">
                <h1 className="text-base sm:text-lg md:text-2xl font-semibold text-gray-900 mb-3">Locations</h1>
                <h2 className="text-base text-textGray">Map</h2>
            </div>
            ...
            <div className="relative bg-white rounded-3xl shadow-sm border border-gray-200 overflow-hidden">
                ...
                <div className="relative h-96 overflow-hidden">
                    ...
                    >
                        ...
                        {/* Custom Zoom Controls (must be inside MapContainer) */}
                        <ZoomControls />
