  ...
  return (
    <div className="group bg-navbarBg border border-border rounded-xl overflow-hidden hover:shadow-md dark:hover:shadow-xl transition-all">
      ...
      <div className="p-4 sm:p-6">
        ...
        {/* Info */}
        <div className="space-y-1 sm:space-y-3 mb-4 sm:mb-5 text-sm sm:text-base text-gray-700 dark:text-gray-300">
        ...
        <Link href={`/screens/${screen.id}`}>
          <button className="w-full shadow-customShadow bg-bgBlue hover:bg-blue-600 text-white font-medium py-2.5 sm:py-3 rounded-lg transition-colors flex items-center justify-center gap-2 cursor-pointer text-sm sm:text-base">
