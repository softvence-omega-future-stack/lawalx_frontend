...
export default function ScheduleDetailPage() {
  ...
  const isNew = id === "new";
  const initialSchedule = mockSchedules.find((s) => s.id === id) || {
    id: "new",
    name: "",
    description: "",
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-7 space-y-6">
          <BasicInfoForm
            ...
            setDescription={(description) => setSchedule({ ...schedule, description })}
          />

          <ContentSection
            contentType={schedule.contentType}
            setContentType={(contentType: any) => setSchedule({ ...schedule, contentType })}
            content={schedule.content}
          />

          <ScheduleTimeSection
            repeat={schedule.repeat}
            setRepeat={(repeat: any) => setSchedule({ ...schedule, repeat })}
          />
