...
//             <button onClick={() => router.push("/screens")} className="hover:bg-gray-100 rounded-lg transition-colors mt-1 p-1 cursor-pointer" > <ArrowLeft className="w-6 h-6 text-Heading" />
//             </button>
//             <div>
//               <h1 className="text-lg sm:text-2xl md:text-[30px] font-semibold text-gray-900"> {screen.title} </h1>
//               <p className="text-sm sm:text-base text-textGray mt-1"> {screen.description} </p>
//             </div>
//           </div>
...
//               className={`px-4 py-2 rounded-lg border cursor-pointer ${activeTab === tab
