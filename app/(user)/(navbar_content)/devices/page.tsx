...
//       {/* Stats Cards */}
      ...
      //         <button className="py-2 px-4 bg-gray-900 shadow-customShadow text-white text-sm font-medium rounded-lg hover:bg-gray-800 transition-colors cursor-pointer">
      //           Upgrade Plan
      //         </button>
      //       </Link>
      //     </div>
...
export default function DevicesPage() {
  ...
  return (
    <div className="min-h-screen">
      {/* Header + Stats */}
      <div className="mb-6">
        <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-1">My Devices</h1>
        <p className="text-sm text-gray-500">Screencasts when and where your content should play</p>
      </div>
      ...
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-lg font-semibold">{devices.length} Devices</h2>
        <button onClick={() => setIsAddOpen(true)} className="px-6 py-3 cursor-pointer bg-bgBlue text-white rounded-xl flex items-center gap-2 shadow-customShadow hover:scale-105 transition">
